# --- Section #23: Git and Github --- #
"""
    - git clone                             --> for clonning or copying a repository to a computer                                              
    - git add -A or .                       --> Add changes
    - git commit -m 'Commit message'        --> Save changes with messages
